...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid Margin="15">
        ...
        <StackPanel Grid.Row="0" Margin="0,0,0,15">
            ...
            <TextBlock Text="$totalCards cards total  Â·  Last refresh: $(Get-Date -Format 'HH:mm:ss')" FontSize="12" Foreground="#AAA" Margin="0,5,0,0" />
        </StackPanel>
...
"@
    ...
    foreach ($c in $colors) {
        ...
        # â”€â”€ TOTAL CARDS SUMMARY (bottom of every tab) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        $tabGoal   = 0
        $tabActual = 0
        foreach ($t in $types) {
