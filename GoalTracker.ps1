...
"@
    ...
    # Output 'SUCCESS' if we get this far without error.
    Write-Host "SUCCESS"
} catch {
    [System.Windows.Forms.MessageBox]::Show(Add-Type -AssemblyName PresentationFramework
Add-Type -AssemblyName System.Windows.Forms
Add-Type -AssemblyName System.IO.Compression.FileSystem
Add-Type -AssemblyName System.Web.Extensions
...
.Exception.Message, "Goal Tracker Error")
}
